...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag('buttons', '<riotmui-desc> <div class="riotmui-desc-examples"> <material-card> <div class="material-card-title">Default Button</div> <div class="material-card-content"> <material-button class="ui"> <div class="text">BUTTON</div> </material-button> </div> <riotmui-code code="{{this.parent.parent.example1}}"></riotmui-code> </material-card> <material-card> <div class="material-card-title">Rounded Button</div> <div class="material-card-content"> <material-button class="ui" center="true" waves-center="true" rounded="true" waves-opacity="0.6" waves-duration="600" style="background:#f43137"> <i class="material-icons">add</i> </material-button> </div> <riotmui-code code="{{this.parent.parent.example2}}"></riotmui-code> </material-card> <material-card> <div class="material-card-title">Button With Icon</div> <div class="material-card-content"> <material-button class="ui" waves-color="#000" style="background:#ed7ff4; height: 50px; line-height: 46px"> <div class="text">CREATE</div> <i class="material-icons">create</i> </material-button> </div> <riotmui-code code="{{this.parent.parent.example3}}"></riotmui-code> </material-card> </div> <div class="riotmui-desc-description"> <p>This component generate MUI button. It has two sets of options - button options and waves options (material-waves it is sub component which provide material ripple). </p> </div> </riotmui-desc>', function (opts) {
	  ...
	  this.example3 = "<material-button class=\"ui\" waves-color=\"#000\" style=\"background:#ed7ff4; height: 50px; line-height: 46px\">\n      <div class=\"text\">ICON</div>\n      <i class=\"material-icons\">create</i>\n  </material-button>";
	});
